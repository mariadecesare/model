...
def tf_popvec(y):
    ...
    # AttributeError: module 'tensorflow' has no attribute 'mod'
    return tf.compat.v1.mod(loc, 2*np.pi)    
...
class LeakyRNNCell(RNNCell):
    ...
    def call(self, inputs, state):
        ...
        noise = tf.compat.v1.random_normal(tf.shape(input=state), mean=0, stddev=self._sigma)
...
class Model(object):
    ...
    def __init__(self,
        ...
        # function is deprecated, new function:
    ...
    def _build_fused(self, hp):
        ...
        # functions depricated, new function:
        ...
        if hp['loss_type'] == 'lsq':
            ...
            # function depricated, new function:
        else:
            # Mask on time
